...
import {Breadcrumb, BreadcrumbItem, Form, FormGroup, Button, Label, Col,Row, Input, FormFeedback} from 'reactstrap';
...
class Contact extends Component {
    ...
    validation = (firstname, lastname, telnum, email) =>{
        ...
        if(this.state.touched.telnum && !reg.test(telnum)){
            errors.telnum="it should contain only digits"
        }
                ...
                <div className="col-12 col-md-9">
                    ...
                    <FormGroup row>
                        <Label htmlFor="firstname" md={2}>First Name</Label>
                            ...
                            <FormGroup row>
                                <Label htmlFor="Tel." md={2}>Contact Number</Label>
                                <Col md={10}>
